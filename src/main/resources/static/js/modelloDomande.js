...
domande.stampanti.elencoDomande.push(new Domanda("La mia nuova stampante è per …", "", 
	new Array(new Risposta("Uso personale", "Il dispositivo sarà utilizzato per documenti personali, da me e la mia famiglia."), 
				new Risposta("Home office", "Il dispositivo sarà utilizzato in un home office per creare documenti professionali." ), 
				new Risposta("Piccola azienda", "Il dispositivo sarà utilizzato in un ufficio con un massimo di 10 persone."),
				new Risposta("Grande azienda", "Il dispositivo sarà utilizzato in un ufficio con più di 10 persone."))));
...
domande.stampanti.elencoDomande.push(new Domanda("Devo poter stampare…%Puoi selezionare più opzioni", "Formato di stampa%Scegli il formato sui cui desideri stampare, dallo standard A4 fino ai grandi formati o alle foto.",
	new Array(new Risposta("Documenti con solo testo", "I documenti stampati saranno soprattutto documenti di testo come email, fogli Word o fogli di calcolo."), 
				...
				new Risposta("Su etichette e buste", "Ideale per chi vuole stampare su etichette o buste." ),
				new Risposta("In formato standard A4", "Documenti in formato standard A4." ),
				new Risposta("Nel grande formato A3", "Documenti in A3 per chi vuole stampare in un formato più grande." ),
				new Risposta("Nei formati più piccoli A5 e A6", "Documenti in formato A5 / A6 ideali per piccoli volantini." ))));
