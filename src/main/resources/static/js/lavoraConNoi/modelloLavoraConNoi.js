...
elementiNav[1] = new Array(
	...
	new VoceNav("Spontaneous Candidature", "javascript:avanti()"));
...
elementiNav[2] = new Array(
	...
	new VoceNav("Spontaneous Candidature", "javascript:vaiTesto2()"));

/* div testoCandidatura */	

candidaturaSpontanea = new Array();

candidaturaSpontanea[0] = "If at the moment there are no positions in line with your profile, you can in any case send us your application spontaneously: you will be contacted in case positions are opened in line with your characteristics.";
candidaturaSpontanea[1] = "Don't meet the minimum requirements? You can always send us a spontaneous candidature.";	
...
sezioniTesti = new Array(
	...
	new Sezione("", ""),
	new Sezione("Posizione", "Descrizione posizione")
); 