...
elementiNav[1] = new Array(
	...
	new VoceNav("Spontaneous Candidature", "javascript:avantiDueVolte()"));
...
elementiNav[3] = new Array(
	new VoceNav("Open Positions", "javascript:indietroDueVolte()"),
...
candidatura[2] = new Candidatura("By clicking on the \"send curriculum\" button, you accept the information on online candidates pursuant to art. 13 of Regulation (EU) 2016/679.", "javascript:inviaPresentazione()");
